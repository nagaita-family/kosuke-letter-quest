...
(async()=>{
  ...
  await page.goto(base+'?v=12.5');assert.equal(await page.title(),'Kosuke Letter Quest v12.5');
  ...
  console.log('Production v12.5: all three asset hashes match; real keyboard walk / stop / sword / XP passed.');
